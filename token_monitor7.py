...
class TokenScorer:
    ...
    def _get_sniper_score(self, tx_data: tuple) -> float:
        ...
        try:
            ...
            # Automatic low score if too many snipers or insiders
            if sniper_count > 2 or insider_count > 2:
                return 20.0
                
            # Base score starts at 100 and gets reduced
            score = 100.0
            
            # Penalize for each sniper and insider
            score -= (sniper_count * 25)
            score -= (insider_count * 25)
